...
/// 更新批量付款单命令
/// </summary>
public record UpdatePaymentAutoCommand
{
    ...
    public IReadOnlyList<UpdatePaymentAutoDetailCommand> Details { get; init; } = Array.Empty<UpdatePaymentAutoDetailCommand>();
    public IReadOnlyList<UpdatePaymentAutoAgentCommand> Agents { get; init; } = Array.Empty<UpdatePaymentAutoAgentCommand>();
}

/// <summary>
/// 更新批量付款明细命令
/// </summary>
public record UpdatePaymentAutoDetailCommand
{
    public Guid? Id { get; init; }
...
/// 更新批量付款供应商命令
/// </summary>
public record UpdatePaymentAutoAgentCommand
{
    public Guid? Id { get; init; }
