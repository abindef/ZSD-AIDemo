...
```typescript
// 分页查询
GET /v1.0/finance-backend/api/paymentAuto/page
  ?page=1&limit=20&status=0&code=xxx

// 状态统计
GET /v1.0/finance-backend/api/paymentAuto/statusCount

// 获取供应商信息
GET /v1.0/finance-backend/api/paymentAuto/{id}/agents

// 获取付款明细
GET /v1.0/finance-backend/api/paymentAuto/{id}/details

// 创建
POST /v1.0/finance-backend/api/paymentAuto

// 更新
PUT /v1.0/finance-backend/api/paymentAuto/{id}

// 删除
DELETE /v1.0/finance-backend/api/paymentAuto/{ids}
```

### 7.2 应付单接口
```typescript
// 查询应付明细列表（用于对话框选择）
GET /v1.0/finance-backend/api/debt/details
